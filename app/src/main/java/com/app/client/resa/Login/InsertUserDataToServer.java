 ...
 */
public class InsertUserDataToServer {

    public UserLoginInfo getInsertUserURLResponse(String urlString, String full_name, String email_address, String pass) throws Exception {
        ...
        tokenUri.append("&user_name=");
        tokenUri.append(URLEncoder.encode(full_name, "UTF-8"));
        String status = "";
